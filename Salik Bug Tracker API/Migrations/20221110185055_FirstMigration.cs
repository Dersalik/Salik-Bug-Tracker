        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IssueSummary = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateSolved = table.Column<DateTime>(type: "datetime2", nullable: false),
                    SolutionDetail = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_bugDevelopers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_bugDevelopers_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_bugDevelopers_bugs_BugId",
                        column: x => x.BugId,
                        principalTable: "bugs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_bugDevelopers_ApplicationUserId",
                table: "bugDevelopers",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_bugDevelopers_BugId",
                table: "bugDevelopers",
                column: "BugId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ModuleUsers_ApplicationUserId",
                table: "ModuleUsers",
                column: "ApplicationUserId");
